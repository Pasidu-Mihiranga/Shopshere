  ...
  return (
    <div className="login-page">
          ...
          <div className="dev-tools">
            ...
            <div className="test-section">
              ...
              <div className="test-buttons">
                ...
                <button 
                  type="button"
                  className="btn-create shop-owner"
                  onClick={() => handleQuickRegister('shop_owner')}
                  disabled={loading}
                >
            ...
            <div className="debug-info">
              <details>
                ...
                <div className="debug-content">
                  ...
                  <p><strong>Login Endpoint:</strong> {API_BASE}/api/auth/login</p>
                  <p><strong>Register Endpoint:</strong> {API_BASE}/api/auth/register</p>
                  <p><strong>Health Endpoint:</strong> {API_BASE}/api/health</p>
                  <p><strong>Auth Utils Authenticated:</strong> {authUtils.isAuthenticated() ? 'Yes' : 'No'}</p>
                  <p><strong>Token in Storage:</strong> {localStorage.getItem('token') ? 'Yes' : 'No'}</p>
                  <p><strong>User in Storage:</strong> {localStorage.getItem('user') ? 'Yes' : 'No'}</p>
                </div>
              </details>
            </div>
          </div>
      ...
      <style jsx>{`
        ...
        .btn-test.customer, .btn-create.customer {
          background: #007bff;
          color: white;
        }
        
        .btn-test.shop-owner, .btn-create.shop-owner {
          background: #28a745;
          color: white;
        }
        
        .btn-test:hover, .btn-create:hover {
          opacity: 0.8;
        }
        
        .btn-test:disabled, .btn-create:disabled {
          opacity: 0.5;
          cursor: not-allowed;
        }
